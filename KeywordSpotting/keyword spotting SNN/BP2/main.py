...
parser.add_argument("--n_input",type=int,default=930)           # 输入维度 （频率）
parser.add_argument("--2",type=int,default=200)          # 时间维度
# Time Dimension:
...
args.dataset_path = "./dataset_test/gamma_002.mat" # 数据集路径
