...
from model import train_snn, print_results
...
# snn = SNN_sample(...)
from model import SNN_SynapticDelay
snn = SNN_SynapticDelay(device=device, n_input=args.n_input, n_class=args.n_classes).to(device)
